/*
 ...
 Locally bundled for Getting Back to Tri v1.9.2.
*/
(function(global){
  "use strict";
  const modules = {};
  ...
  function normalise(id){
    return String(id || "").replace(/\\/g,"/").replace(/^\.\//,"").replace(/\.js$/,"");
  }
  function requireLocal(id){
    ...
    cache[id] = module;
    modules[id](module, module.exports, requireLocal);
...
module.exports = QRCode;
  ...
  global.GBTT_QRCode = requireLocal("index");
  global.GBTT_QRErrorCorrectLevel = requireLocal("QRErrorCorrectLevel");
})(globalThis);
